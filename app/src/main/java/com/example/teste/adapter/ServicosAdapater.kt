...
import com.example.teste.databinding.ServicosItemBinding
import com.example.teste.model.Servicos

class ServicosAdapater(private val context: Context, private val listaServicos: MutableList<Servicos>):
    RecyclerView.Adapter<ServicosAdapater.ServicosViewHolder>() {
